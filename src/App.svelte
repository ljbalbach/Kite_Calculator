	...
	<main>
		...
		<div class="image-container">
			{#if recommendedKiteSize === null}
				<img src="public/images/kiter_12.png" alt="Kiteboarder" class="kiter-image">
			{:else if recommendedKiteSize <= 5}
				<img src="public/images/kiter_3.png" alt="Kiteboarder" class="kiter-image">
			{:else if recommendedKiteSize <= 9}
				<img src="public/images/kiter_7.png" alt="Kiteboarder" class="kiter-image">
			{:else if recommendedKiteSize <= 15}
				<img src="public/images/kiter_12.png" alt="Kiteboarder" class="kiter-image">
			{:else if recommendedKiteSize <= 20}
				<img src="public/images/kiter_18.png" alt="Kiteboarder" class="kiter-image">
			{:else if recommendedKiteSize > 20}
				<img src="public/images/kiter_24.png" alt="Kiteboarder" class="kiter-image">
			{/if}
		</div>
...
<style>
	:global(body) {
		...
		overflow: hidden;
		background-image: url('public/images/beach.jpeg');
